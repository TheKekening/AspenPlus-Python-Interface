...
NOTE: THIS REPO IS A CLONE OF THE ORIGINAL REPO BY Richard Wolfgang. I intend on using this repo to add additional functionality to the Aspen-Python API
...
https://github.com/edgarsmdn/Aspen\_HYSYS\_Python
